...
serv_adm = config.get('server','admin_server')
url_adm = 't3://localhost:' + port_adm

# Configurações do DataSource
ds_name = 'siscodiDS'
jndi_name = 'siscodiDS'
driver = 'ssa.db.driver.SSADriver'
...
###
# Iniciar verificaçã da existência do DATAOURCE siscodiDS
###
...
###
# Iniciar a criação do DATAOURCE siscodiDS
###
